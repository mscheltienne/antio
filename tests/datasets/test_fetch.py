...
from antio.datasets._fetch import fetch_dataset
...
def license_file() -> Optional[Path]:
    ...
    fname = Path(__file__).parent.parent.parent / "LICENSE"
    if fname.exists():
        return fname
    else:
...
def license_url() -> str:
    ...
    return "https://raw.githubusercontent.com/mscheltienne/antio/main/"
